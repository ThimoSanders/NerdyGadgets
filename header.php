    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light w-100">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownCategory">
                        ...
                        ?>
                            <a class="dropdown-item" href="browse.php?category_id=<?=$HeaderStockGroup['StockGroupID']?>"><?= $HeaderStockGroup['StockGroupName']?></a>
                        <?php
                            }
                        ?>
                ...
                <li class="nav-item">
                    <a href="browse.php" class="nav-link"><i class="fas fa-search" style="color:#676EFF;"></i> Zoeken</a>
                </li>
            </ul>
            <ul class="navbar-nav ml-auto">
                ...
                ?>
                        <li class="nav-item">
                            <a href="login.php" class="nav-link"><i style="color:#676EFF;"></i> Inloggen</a>
                        </li>
                <?php
                    }
               ?>
